    ...
    <section id="contact" className="py-14 md:py-24 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-5 gap-8 items-start">
          {/* Info panel */}
          <div className="md:col-span-2 bg-white border border-gray-100 rounded-2xl p-5 sm:p-8 shadow-sm">
          ...
          {/* Form */}
          <div className="md:col-span-3 bg-white rounded-2xl p-5 sm:p-8 shadow-sm border border-gray-100">
