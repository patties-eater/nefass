...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-14 md:py-24 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        {/* Header */}
        <div className="text-center max-w-xl mx-auto mb-8 md:mb-14">
          <p className="text-xs font-bold tracking-widest uppercase text-brand mb-2">Contact Us</p>
        ...
        {/* Quick call strip — mobile only */}
        <div className="md:hidden flex gap-3 mb-6">
          <a href="tel:+97715201750" className="flex-1 flex items-center justify-center gap-2 bg-navy text-white font-bold py-3 rounded-xl text-sm">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
              <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.68 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.59 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.54a16 16 0 0 0 6 6l.91-.91a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>
            </svg>
            Call Us
          </a>
          <a href="https://wa.me/9779851120100" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 bg-green-500 text-white font-bold py-3 rounded-xl text-sm">
        ...
        <div className="grid md:grid-cols-5 gap-5 md:gap-8 items-start">
          {/* Info panel — hidden on mobile (replaced by quick strip above) */}
          <div className="hidden md:block md:col-span-2 bg-white border border-gray-100 rounded-2xl p-5 sm:p-8 shadow-sm">
          ...
          {/* Form */}
          <div className="col-span-full md:col-span-3 bg-white rounded-2xl p-5 sm:p-8 shadow-sm border border-gray-100">
